var loadState = {
	...
	preload: function(){
		...
		game.load.images(['pipe', 'steamOld', 'player', 'heartOld', 'enemyOld', 'wall', 'ooze', 'leakOld', 'instructions', 'steamMachine', 'text3','text2','text4','text5', 'startScreen', 'heart', 'water'],
		['pipeProto.png', 'steamProto.png', 'playerProto.png', 'heartProto.png', 'enemyProto.png', 'wallProto.png', 'oozeProto.png', 'leakProto.png', 'instructions.png', 'steammachine.png',  'text3.png', 'text22.png','text44.png','text55.png', 'startscreen.png', 'heart.png', 'water2.png']);
