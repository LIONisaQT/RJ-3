...
var loadState = {
	...
	preload: function(){
		...
		game.load.images(['pipe', 'steam', 'player', 'enemy', 'wall', 'ooze', 'leak', 'instructions'],
		['pipeProto.png', 'steamProto.png', 'playerProto.png', 'enemyProto.png', 'wallProto.png', 'oozeProto.png', 'leakProto.png', 'instructions.png']);
